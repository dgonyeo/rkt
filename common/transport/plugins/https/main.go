...
func errAndExit(config *plugins.Config, format string, args ...interface{}) {
...
func main() {
	config, err := plugins.ConfigFromStdin()
	if err != nil {
...
func fetch(config *plugins.Config) error {
	...
	return plugins.ResultToStdout(res)
}
